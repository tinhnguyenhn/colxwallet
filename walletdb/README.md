...
[![GoDoc](https://godoc.org/github.com/tinhnguyenhn/colxwallet/walletdb?status.png)]
(http://godoc.org/github.com/tinhnguyenhn/colxwallet/walletdb)
...
http://localhost:6060/pkg/github.com/tinhnguyenhn/colxwallet/walletdb

## Installation

```bash
$ go get github.com/tinhnguyenhn/colxwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/tinhnguyenhn/colxwallet/walletdb#example-package--BasicUsage)  
